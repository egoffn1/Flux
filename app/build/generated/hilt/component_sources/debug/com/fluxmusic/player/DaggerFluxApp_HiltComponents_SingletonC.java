...
import com.fluxmusic.player.di.AppModule;
import com.fluxmusic.player.di.AppModule_ProvideContentResolverFactory;
import com.fluxmusic.player.di.DatabaseModule;
import com.fluxmusic.player.di.DatabaseModule_ProvideDatabaseFactory;
import com.fluxmusic.player.di.DatabaseModule_ProvideFavoriteDaoFactory;
import com.fluxmusic.player.di.DatabaseModule_ProvidePlaylistDaoFactory;
import com.fluxmusic.player.di.DatabaseModule_ProvideTrackDaoFactory;
...
import com.fluxmusic.player.playback.MusicService;
import com.fluxmusic.player.playback.MusicService_MembersInjector;
import com.fluxmusic.player.playback.QueueManager;
import com.fluxmusic.player.ui.screens.library.LibraryViewModel;
import com.fluxmusic.player.ui.screens.library.LibraryViewModel_HiltModules_KeyModule_ProvideFactory;
import com.fluxmusic.player.ui.screens.playlists.PlaylistsViewModel;
import com.fluxmusic.player.ui.screens.playlists.PlaylistsViewModel_HiltModules_KeyModule_ProvideFactory;
import com.fluxmusic.player.ui.screens.search.SearchViewModel;
import com.fluxmusic.player.ui.screens.search.SearchViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerFluxApp_HiltComponents_SingletonC {
  private DaggerFluxApp_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public FluxApp_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements FluxApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public FluxApp_HiltComponents.ActivityRetainedC build() {
      return new ActivityRetainedCImpl(singletonCImpl);
    }
  }

  private static final class ActivityCBuilder implements FluxApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public FluxApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements FluxApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public FluxApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements FluxApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public FluxApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements FluxApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public FluxApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements FluxApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public FluxApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements FluxApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public FluxApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends FluxApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends FluxApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends FluxApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends FluxApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
    ...
    public Set<String> getViewModelKeys() {
      return ImmutableSet.<String>of(LibraryViewModel_HiltModules_KeyModule_ProvideFactory.provide(), PlaylistsViewModel_HiltModules_KeyModule_ProvideFactory.provide(), SearchViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends FluxApp_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
    ...
    private GetAllTracksUseCase getAllTracksUseCase() {
      return new GetAllTracksUseCase(singletonCImpl.musicRepositoryImplProvider.get());
    }

    private GetAlbumsUseCase getAlbumsUseCase() {
      return new GetAlbumsUseCase(singletonCImpl.musicRepositoryImplProvider.get());
    }

    private GetArtistsUseCase getArtistsUseCase() {
      return new GetArtistsUseCase(singletonCImpl.musicRepositoryImplProvider.get());
    }

    private SearchTracksUseCase searchTracksUseCase() {
      return new SearchTracksUseCase(singletonCImpl.musicRepositoryImplProvider.get());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return ImmutableMap.<String, Provider<ViewModel>>of("com.fluxmusic.player.ui.screens.library.LibraryViewModel", ((Provider) libraryViewModelProvider), "com.fluxmusic.player.ui.screens.playlists.PlaylistsViewModel", ((Provider) playlistsViewModelProvider), "com.fluxmusic.player.ui.screens.search.SearchViewModel", ((Provider) searchViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 2: // com.fluxmusic.player.ui.screens.search.SearchViewModel 
          return (T) new SearchViewModel(viewModelCImpl.searchTracksUseCase(), singletonCImpl.favoritesRepositoryImplProvider.get(), singletonCImpl.queueManagerProvider.get(), singletonCImpl.mediaSessionConnectionProvider.get());
  ...
  private static final class ActivityRetainedCImpl extends FluxApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends FluxApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
    ...
    private MusicService injectMusicService2(MusicService instance) {
      MusicService_MembersInjector.injectQueueManager(instance, singletonCImpl.queueManagerProvider.get());
      return instance;
    }
  }

  private static final class SingletonCImpl extends FluxApp_HiltComponents.SingletonC {
    private final ApplicationContextModule applicationContextModule;

    private final SingletonCImpl singletonCImpl = this;

    private Provider<MediaSessionConnection> mediaSessionConnectionProvider;
    ...
    @Override
    public void injectFluxApp(FluxApp fluxApp) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.fluxmusic.player.playback.MediaSessionConnection 
          return (T) new MediaSessionConnection(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
          ...
          case 11: // com.fluxmusic.player.data.local.dao.PlaylistDao 
